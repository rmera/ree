...
func main() {
	...
	flag.Parse()
	fmt.Println("xtbRE: Performs a replica exchange simulation with xtb")
	fmt.Println("Use: xtbRE OPTIONS geometry.xyz SIMULATION_TIME")
	fmt.Println("Use xtbRE --help to see the available options")
